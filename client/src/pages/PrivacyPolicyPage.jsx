...
const SECTIONS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Usage information: basic first-party usage events, such as when the app is opened and when key features are used (for example, completing a check-in, logging a medication, or exporting a report). These events are generated by the app itself, stored on our own servers, and are used only in aggregate to understand which features are helpful.",
    ],
    after: [
      "We do not use third-party analytics, advertising networks, or tracking technologies. Usage information stays on our own servers and is never shared. We do not collect your precise location, contacts, or device identifiers for advertising.",
    ],
  },
  {
    ...
    bullets: [
      ...
      "To understand, in aggregate, which features are used so we can prioritize improvements. We look at usage patterns as counts and trends, not to profile individuals.",
    ],
    after: [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Delete: delete your account at any time from Profile, then Delete account. This permanently removes your account and all associated data — check-ins, medications, logs, appointments, and usage events — from our active database.",
