...
function TrendsPage() {
  ...
  const getMedicationAdherence = (periodLogs) =>
    medications
      .filter((m) => m.active)
      .map((med) => {
  ...
  const getDailyAdherenceData = (periodLogs) => {
    const byDate = {};
        ...
        {loading ? (
          ...
          <>
            ...
            {medications.some((m) => m.active) && (() => {
              ...
              const medAdherence      = getMedicationAdherence(periodLogs);
